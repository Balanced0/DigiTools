        ...
        <div>
            <div className="container mx-auto text-center flex flex-col items-center justify-center">
                ...
                <div className="inline-flex rounded-full border border-neutral-200 p-0.5 mb-10">
                    <button className="btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white font-bold py-6 px-6 rounded-full">Products</button>
                    <button className="btn font-bold py-6 px-6 rounded-full text-[#25065D] border-none bg-white">Cart (0)</button>
                </div>
            </div>
        </div>
    );
